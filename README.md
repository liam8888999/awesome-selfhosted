...
- [ErsatzTV](https://ersatztv.org) - ErsatzTV is beta software for configuring and streaming custom live channels using your media library. The software may be unstable and is under active development. ([Source Code](https://github.com/ErsatzTV/ErsatzTV)) `Zlib` `C#`
